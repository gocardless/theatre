...
import (
	...
	controllers "github.com/gocardless/theatre/v5/internal/controller/deploy"
...
var (
	...
	app           = kingpin.New("automated-rollback-policy-manager", "Manages automated rollback policies").Version(cmd.VersionStanza())
...
func main() {
	...
	manager, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID: "automatedrollbackpolicy.deploy.crd.gocardless.com",
		Scheme:           scheme,
	...
	if err = (&controllers.AutomatedRollbackPolicyReconciler{
