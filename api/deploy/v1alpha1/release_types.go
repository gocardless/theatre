...
type ReleaseSpec struct {
	// TODO: rename to UtopiaServiceTargetRelease use the name instead
	// UtopiaServiceTarget specifies the utopia target service for the release i.e.
	// the name of the utopia service target that this release is from.
	// +kubebuilder:validation:Required
	UtopiaServiceTarget string `json:"utopiaServiceTarget"`
...
// based on utopiaServiceTarget and revision IDs. Leave it empty on creation.
type Release struct {
