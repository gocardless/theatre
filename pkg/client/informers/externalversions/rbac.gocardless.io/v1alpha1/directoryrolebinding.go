...
import (
	...
	rbacgocardlessiov1alpha1 "github.com/lawrencejones/rbac-directory/pkg/apis/rbac.gocardless.io/v1alpha1"
	...
	v1alpha1 "github.com/lawrencejones/rbac-directory/pkg/client/listers/rbac.gocardless.io/v1alpha1"
...
func NewFilteredDirectoryRoleBindingInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&rbacgocardlessiov1alpha1.DirectoryRoleBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *directoryRoleBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rbacgocardlessiov1alpha1.DirectoryRoleBinding{}, f.defaultInformer)
}
