...
func (c *FakeConsoleAuthorisations) List(opts v1.ListOptions) (result *v1alpha1.ConsoleAuthorisationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeConsoleAuthorisations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeConsoleAuthorisations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(consoleauthorisationsResource, c.ns, listOptions)
